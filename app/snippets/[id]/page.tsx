...
import { ArrowLeft, Eye, Clock, Edit, Trash2, Share2, Copy } from "lucide-react"
...
export async function generateMetadata({ params }: { params: { id: string } }) {
  ...
  return {
    ...
    description: snippet.description || `Code snippet in ${snippet.language} by ${snippet.author.username}`,
    keywords: [snippet.language, ...snippet.tags, 'code snippet', 'programming'],
    ...
    openGraph: {
      ...
      images: [
        {
          url: `${baseUrl}/api/og?title=${encodeURIComponent(snippet.title)}&language=${snippet.language}`,
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: snippet.title,
      description: snippet.description || `Code snippet in ${snippet.language}`,
      images: [`${baseUrl}/api/og?title=${encodeURIComponent(snippet.title)}&language=${snippet.language}`],
    },
    alternates: {
        ...
        <Card className="mt-6">
          <CardHeader>
            ...
            >
              ...
              <div>
                <h3 className="text-lg font-semibold">{snippet.author.name || snippet.author.username}</h3>
